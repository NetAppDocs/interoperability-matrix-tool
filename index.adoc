...
keywords: interoperability matrix tool, ONTAP SAN Host Solutions,
...
You can view the results in the *Result* page. Using this tool, you can search for components, make selections, build criteria, and view the compatibilities of your product.
...
NOTE: To find previously saved searches, you can use the *Saved Search* menu. If you cannot find the configuration you need, click the xref:using-cannot-find-config.adoc[Can't Find Config?] menu and report the problem.
