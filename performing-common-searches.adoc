...
summary:  'Use the cards on the home page of the Interoperability Matrix Tool (IMT) to perform common searches, including the ONTAP SAN Host Simplified, Solution Search, List and Find, and Advanced Search.'
---
...
[.lead]
Use the cards on the home page of the Interoperability Matrix Tool (IMT) to perform common searches, including the *ONTAP SAN Host Simplified*, *Solution Search*, *List and Find*, and *Advanced Search*.
