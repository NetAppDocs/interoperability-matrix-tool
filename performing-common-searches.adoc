...
You can also watch training videos or open the https://www.netapp.com/services/support/active-iq/#:~:text=NetApp%C2%AE%20Active%20IQ%C2%AE,availability%2C%20security%2C%20and%20performance[Active IQ Advisor] from the home page.
